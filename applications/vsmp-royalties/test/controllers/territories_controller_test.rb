...
class TerritoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create territory" do
    assert_difference("Territory.count") do
      post territories_url, params: { territory: { iso_code: @territory.iso_code, name: @territory.name } }
    end
  ...
  test "should update territory" do
    patch territory_url(@territory), params: { territory: { iso_code: @territory.iso_code, name: @territory.name } }
