...
class ImportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update import" do
    patch import_url(@import), params: { import: { fiscal_quarter: @import.fiscal_quarter, fiscal_year: @import.fiscal_year, number_of_royalties_added: @import.number_of_royalties_added, original_file_name: @import.original_file_name } }
